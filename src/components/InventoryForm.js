...
import { postImageThunk } from "../redux/actions/formAction";
  ...
  return (
    <div>
      <Form onSubmit={handleSubmission}>
        ...
        <Button type="submit" value="submit" className="inventoryCancelBtn">
          CANCEL
        </Button>
        <Button type="submit" value="submit" className="inventoryBtn">
          SUBMIT
        </Button>
      </Form>
    </div>
